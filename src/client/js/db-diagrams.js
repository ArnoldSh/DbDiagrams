...
// TODO: restructure to normal sane JS library!
// TODO: separate namespaces, provide module structure and API
// TODO: check browsers support and implements polyfills if it necessary
// TODO: write customizing of color style IN CSS, but NOT IN CODE
// TODO: and many many more...
// sorry, it is my first JS CODE IN MY LIFE and I was noob
var _links = [];
...
// -----/ FOR BETTER LIFE - DON'T ALTER! /-----
    ...
    var getRectCorners = function (rect) {
        return {
            topLeft: {
                x: rect.attributes.position.x,
                y: rect.attributes.position.y
            },
            topRight: {
                x: rect.attributes.position.x + rect.getWidth(),
                y: rect.attributes.position.y
            },
            botRight: {
                x: rect.attributes.position.x + rect.getWidth(),
    ...
    var getRectCenter = function (obj) {
        return {
            x: obj.attributes.position.x + obj.getWidth() / 2,
                ...
                case 'table':
                    current = new Table({
                        attrs: {
                            ...
                            '.columns-link': {
                                'xlink:href': element.columns_link,
                                'xlink:show': 'new',
                                'cursor': 'pointer'
                            },
                            '.indicies-link': {
                                'xlink:href': element.indicies_link,
                                'xlink:show': 'new',
                                'cursor': 'pointer'
                            },
                            '.triggers-link': {
                                'xlink:href': element.triggers_link,
                                'xlink:show': 'new',
                                'cursor': 'pointer'
                            }
                        },
        ...
        defaults: joint.util.deepSupplement({
            ...
            attrs: {
                ...
                '.table-name-text': {
                    ...
                    'text-anchor': 'middle',
                    'y-alignment': 'middle',
                    'fill': TABLE_FONT_COLOR,
                    'font-size': TABLE_SUBTITLE_FONT_SIZE,
    ...
    Table = joint.shapes.basic.Generic.extend({
        ...
        defaults: joint.util.deepSupplement({
            ...
            attrs: {
                ...
                '.table-columns-title-rect': {
                    'stroke': TABLE_STROKE_COLOR,
                    'stroke-width': TABLE_STROKE_WIDTH,
                    'fill': TABLE_COLUMNS_TITLE_RECT_COLOR
                },
                '.table-columns-rect': {
                    'stroke': TABLE_STROKE_COLOR,
                    'stroke-width': TABLE_STROKE_WIDTH,
                    'fill': TABLE_COLUMNS_RECT_COLOR
                },
                '.table-indicies-title-rect': {
                    'stroke': TABLE_STROKE_COLOR,
                    'stroke-width': TABLE_STROKE_WIDTH,
                    'fill': TABLE_INDICIES_TITLE_RECT_COLOR
                },
                '.table-indicies-rect': {
                    'stroke': TABLE_STROKE_COLOR,
                    'stroke-width': TABLE_STROKE_WIDTH,
                    'fill': TABLE_INDICIES_RECT_COLOR
                },
                '.table-triggers-title-rect': {
                    'stroke': TABLE_STROKE_COLOR,
                    'stroke-width': TABLE_STROKE_WIDTH,
                    'fill': TABLE_TRIGGERS_TITLE_RECT_COLOR
                },
                '.table-triggers-rect': {
                    'stroke': TABLE_STROKE_COLOR,
                    'stroke-width': TABLE_STROKE_WIDTH,
                    'fill': TABLE_TRIGGERS_RECT_COLOR
                },
                ...
                '.table-columns-pk-text': {
                    'ref': '.table-columns-rect',
                    'ref-y': 5,
                    'ref-x': 5,
                    'fill': TABLE_FONT_COLOR,
                    'font-size': TABLE_FIELDS_FONT_SIZE,
                    'font-family': FONT_FAMILY,
                    'font-weight': 'bold'
                },
                '.table-indicies-title-text': {
                    'ref': '.table-indicies-title-rect',
                    'ref-y': .5,
                    'ref-x': .5,
                    'text-anchor': 'middle',
                    'y-alignment': 'middle',
